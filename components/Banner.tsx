		...
		<div className='relative overflow-hidden'>
			...
			>
				<div className='lg:px-20 py-20 lg:py-40 text-white space-y-14 flex flex-col items-center lg:items-start md:items-center md:justify-center'>
					<div className='px-16 lg:px-20 font-bold text-4xl lg:text-7xl text-center lg:text-left md:text-left'>
			...
			<motion.div
				...
				viewport={{ once: true }}
				transition={{ duration: 0.8, ease: 'easeOut' }}
				className='absolute top-0 -right-50 lg:right-30 overflow-hidden scale-130 md:scale-107 -rotate-32 md:-rotate-12 z-20'
			>
			...
			<motion.div
				...
				viewport={{ once: true }}
				transition={{ duration: 0.8, ease: 'easeOut' }}
				className='absolute top-0 -right-110 lg:-right-90 overflow-hidden scale-130 md:scale-107 -rotate-32 md:-rotate-12 z-20'
			>
