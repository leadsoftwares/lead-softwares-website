...
export default function TeamSection() {
	...
	return (
		...
		>
			...
			<div className='flex flex-wrap justify-center gap-8 md:gap-20 max-w-[80%] mx-auto mt-10 md:mt-30 px-4'>
				{teamStaff.map((staff) => (
					<div key={staff.id} className='rounded-xl overflow-hidden'>
						...
						<div className='border-6 md:border-12 border-blue-700 rounded-full p-2'>
							<div className='relative rounded-full w-52 h-52 md:w-94 md:h-94'>
								<Image
									src={staff.img}
									alt={staff.name}
									fill
