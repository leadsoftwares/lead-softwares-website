    ...
    <div className="w-full scroll-smooth overflow-hidden">
      ...
      >
        ...
        >
          ...
          <div className="lg:w-[60%] mx-auto text-center subTitle text-text text-lg">
          ...
          >
            <div className="boxes flex flex-col items-center md:flex-row md:w-160 lg:w-120 xl:w-160 md:flex-wrap gap-6 mx-auto">
              {strategyBoxes.map((strategyBox, i) => (
                ...
                >
                  <div
                    className={`icon ${strategyBox.bg} w-14 min-h-14 rounded-full flex items-center justify-center`}
                  >
          ...
          >
            <div className="flex flex-col gap-8 w-full">
              <div className="text-primary text-3xl md:text-4xl font-semibold leading-10 lg:leading-12">
                Strategies that get you on <br className="hidden" /> the path to
                success
              </div>
