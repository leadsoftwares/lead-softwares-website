...
const PortfolioStyles = () => {
	...
	return (
		<div className='w-full overflow-hidden'>
				...
				<div className='flex flex-col lg:flex-row gap-10 mx-10 lg:mx-25'>
					<div className='space-y-3'>
						...
						<div className='text-zinc-500 text-lg'>
							Allows users to display their portfolio items in either a carousel
							or a grid layout, with different stylings.
						</div>
					</div>
					<div className='space-y-3'>
						<div className='title font-bold text-xl text-primary'>
			...
			{/*  */}
			<div className='w-full min-h-170 lg:overflow-hidden mt-44 lg:mt-54'>
				<motion.div
					ref={carousel}
					drag='x'
					whileDrag={{ scale: 0.95 }}
			...
			{/*  */}
			<div className='overflow-hidden mt-14 lg:mt-54'>
				<motion.div
					ref={carousel}
					drag='x'
					whileDrag={{ scale: 0.95 }}
			...
			{/*  */}
			<div className='w-full overflow-hidden mt-44 lg:mt-54'>
				<motion.div
					ref={carousel}
					drag='x'
					whileDrag={{ scale: 0.95 }}
						...
						return (
							...
							>
								<Image
									src={itemData?.imgSrc}
									alt='img'
									className='w-full object-contain pointer-events-none hover'
								/>
								<div className='font-bold text-2xl text-primary mt-8 leading-15'>
									{itemData?.title}
								</div>
								<div className='text-primary text-start text-sm'>
									{itemData?.description}
								</div>
							</motion.div>
						)
			...
			{/* our history section */}
			<div className='w-full py-25 bg-bg mt-30'>
				{/* header */}
