          ...
          {ServiceData.map((service, i) => (
            ...
            >
              ...
              >
                ...
                <p className="text-zinc-500 grow">{service.text}</p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, x: 100 }}
                whileInView={{ opacity: 1, x: 0 }}
      ...
      <div className="overflow-hidden py-8 bg-white">
        ...
        <div className={`mb-10 flex items-center justify-center`}>
          {Logos2.map((logo, index) => (
            <div
              key={`logo-${index}`}
              className="mx-4 lg:mx-6 shrink-0 w-14 h-14 sm:w-24 sm:h-24 hover:scale-110 transition-transform duration-300 bg-zinc-100 rounded-full items-center justify-center flex p-3 md::p-4"
            >
              <Image
                width={45}
                height={45}
        ...
        <div className={`flex sm:hidden items-center justify-center`}>
          {Logos5.map((logo, index) => (
            <div
              key={`logo-${index}`}
              className="mx-4 shrink-0 w-14 h-14 hover:scale-110 transition-transform duration-300 bg-zinc-100 rounded-full items-center justify-center flex p-3"
            >
              <Image
                width={40}
                height={40}
